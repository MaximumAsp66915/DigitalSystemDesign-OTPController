# Digital System Design: OTP Memory Controller

Welcome to the repository for the **One-Time Programmable (OTP) Memory Controller** hardware design project. This project was developed as a core laboratory deliverable for the **ASIC/FPGA Design** course.
...
* **Simulation Engine:**
* **Synthesis & Implementation Suite:**
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/MaximumAsp66915/Digital-System-Design-OTP-Controller.git

...
module otp_controller (
    ...
    always @(*) begin
        case (state)
            ...
            STATE_READ_BANK0: next_state = (otp_read_en && addr == 8'd255) ? STATE_READ_PATCH : STATE_READ_BANK0;
            // Same idea for the last patch bit (PATCH1_HI).
            STATE_READ_PATCH: next_state = (otp_read_en && addr == `PATCH1_HI) ? STATE_APPLY : STATE_READ_PATCH;
